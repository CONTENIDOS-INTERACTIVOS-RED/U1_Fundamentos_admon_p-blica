...
.curso-main-container.creditos-vista
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    p.mb-4.mb-md-5 En esta unidad se exploraron los fundamentos de la administración pública en Colombia, destacando su rol como eje central del funcionamiento estatal. Primero, se analizaron los conceptos básicos, resaltando su función en la implementación de políticas públicas y la gestión de recursos para el bienestar social.
    figure
